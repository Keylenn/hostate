...
export default function createScopeStore<I, A extends ActionCreatorsMapObject<I, A>, S extends Record<string, (state: I) => any>>(
  ...
  const useSubscribe = <K extends keyof S>(subKey: K) => {
    ...
    if (ctx === UNDEFINED) throw new Error(`subscription has no a attribute named ${subKey},Please check! Or you don't pass in subscription as the third parameter when creatingScopeStore`)
